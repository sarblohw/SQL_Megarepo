...
select T.title as Track, A.title as Album, T.duration as Duration
from track as T
...
select City.Name as City, Country.Name as Country, Country.Continent as Continent, City.Population as Pop
from City
join Country
on City.CountryCode = Country.Code
where City.Population > 10000000;

select City.CountryCode, Country.Name as Country, avg(City.Population) as avg_pop
from City 
left join Country
on City.CountryCode = Country.Code
