...
select Name as country, LifeExpectancy as lifeexp, Population as pop from Country order by lifeexp limit 5;

select Name as country, 
    LifeExpectancy as life, 
    Population as pop 
    from Country 
    where LifeExpectancy is not null and Population is not null 
    order by pop desc 
    limit 5;
